...
export const PresenceInsertLoader = ({
  event_id,
  user_id,
  invitation_id,
  presencetype_id
}) => (dispatch, getState) => PresenceInsert(event_id, user_id, invitation_id, presencetype_id).then(response => response.json()).then(json => {
