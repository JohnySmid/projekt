...
export const PresenceMutationLoader = ({
  presenceId,
  lastchange,
  presenceTypeId,
  invitationTypeId
}) => (dispatch, getState) => PresenceMutation(presenceId, lastchange, presenceTypeId, invitationTypeId).then(response => response.json()).then(json => {
