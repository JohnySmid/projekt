...
export const EventsDataLoader = () => {
  ...
  */
  ...
  const fetchData = () => (dispatch, getState) => EventsQuery().then(response => response.json()).then(json => {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, isDataLoaded ? /*#__PURE__*/React.createElement("p", null, "Data loaded.") : /*#__PURE__*/React.createElement("p", null, "Loading data..."));
};