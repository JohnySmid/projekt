...
const PresenceInsertJSON = (event_id, user_id, invitation_id, presencetype_id) => ({
  "query": `
    mutation ($user_id: ID!, $event_id: ID!, $invitation_id: ID!, $presencetype_id: ID) {
      presenceInsert(
...
export const PresenceInsert = (event_id, user_id, invitation_id, presencetype_id) => AuthorizedFetch('/gql', {
